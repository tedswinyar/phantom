...
use crate::classify::{HotspotRule, HotspotsSummary, LockVerdict, LockVerify, ToolEstimate};
...
/// the largest roots are the ones checked. Deliberately NOT tied to the
/// `topPaths` list any more: 1.1.1 lets that list grow to 25 roots
/// (phantom-cnr.5), and the subprocess budget of docs/threat-model.md §4
/// stays at five per rule regardless.
pub const MAX_VERIFY_RUNS_PER_RULE: usize = 5;
