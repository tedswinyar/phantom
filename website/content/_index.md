...
hero:
  ...
  screenshot_alt: "Phantom's main window: the treemap of a scanned checkout, the Reclaimable groups, and the file list"
  screenshot_title: "The main window"
  screenshot_body: "The newest scan opens on launch: its treemap up top, the Reclaimable groups with copy-the-command actions, and the largest files beneath."
