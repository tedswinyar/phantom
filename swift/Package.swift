...
let package = Package(
    ...
    targets: [
        ...
        // UI-layer spike (phantom-ozu): tests that depend on the EXECUTABLE
        // target and render real views off-screen with ImageRenderer.
        .testTarget(
            name: "PhantomViewTests",
            dependencies: ["Phantom", "PhantomCore", "DesignKit"],
            path: "Tests/PhantomViewTests",
            swiftSettings: swift6
        ),
        .testTarget(
            name: "DesignKitTests",
