...
final class ServerStartupTests: XCTestCase {
    private let announce = "phantom-api listening on http://127.0.0.1:18770\n"
    ...
    func testDoubleAnnounceInOneChunkResolvesOnce() async throws {
        ...
        XCTAssertEqual(first?.port, 18770, "first announcement wins")
    ...
    func testMultipleConcurrentWaitersAllResolve() async throws {
        ...
        XCTAssertEqual(ports, [18770, 18770, 18770])
    }
